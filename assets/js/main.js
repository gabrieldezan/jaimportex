...
function googleTranslateElementInit() {
    new google.translate.TranslateElement({
        pageLanguage: 'pt',
        includedLanguages: 'en,es,de,fr,pt',
...
function Buscar_blog() {
    var url = vsUrl + "busca-blog/" + $("#campo_buscar_blog").val();
...
function Buscar_produtos() {
    var url = vsUrl + "busca-produtos/" + $("#campo_buscar_produtos").val();
    window.location.href = url;
    //    alert(vsUrl);
}
$("#botao_buscar_produtos").click(function () {
    Buscar_produtos();
});
jQuery('#campo_buscar_produtos').keypress(function (event) {
    var keycode = (event.keyCode ? event.keyCode : event.which);
    if (keycode == '13') {
        Buscar_produtos();
        return false;
