$(document).ready(function () {
    ...
    /*VALIDA TAMANHO E DIMENSÃO DA IMAGEM */
    verifica_tamanho_imagens("servicos");
    verifica_tamanho_imagens("solucoes");
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data !== 0) {
                ...
                $("#inputCapaAtual").val(data[0].capa);
                $("#imgCapaAtual").attr("src", vsUrl + "uploads/servicos/" + data[0].capa);
...
function edita_dados_solucao(viIdSolucoes) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#inputLinkSolucoes").val(data[0].link);
