            ...
            if (data !== 0) {
                ...
                var table = $('#tabela_servicos').DataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "render": function (data, type, row) {
                                return "<a href=\"servicos/cadastro/" + row.id_servicos + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Editar " + row.titulo + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;";
                            }
                        }
                    ],
                    'columnDefs': [
